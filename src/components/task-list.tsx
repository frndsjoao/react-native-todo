...
export const AnimatedTaskItem = (props: TaskItemProps) => {
  const { simultaneousHandlers, data, isEditing, onRemove, onToggleItem, onChangeSubject, onFinishEditing, onPressLabel } = props
...
export default function TaskList(props: TaskListProps) {
  const { data, onRemoveItem, onToggleItem, onChangeSubject, onFinishEditing, onPressLabel, editingItemId } = props
